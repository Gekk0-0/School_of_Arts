...
namespace School_of_arts.Controllers
{
    public class DisciplinesController : Controller
    {
        ...
        public DisciplinesController(SchoolOfArtsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("DisciplineId,SubjectName,TermOfStudy")] Discipline discipline)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DisciplineId,SubjectName,TermOfStudy")] Discipline discipline)
        {
